...
{
  if(!strcmp_ignore_ws(chartName,"FDIBenchMark_BLW_66_71/Controller/Subsystem1/Embedded MATLAB Function/ SFunction "))
  {
 ...
 * plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if(nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if(!strcmp(commandName,"machine")) {
      ...
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4132538318U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1460375665U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2884405801U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(930385203U);
      ...
      switch(chartFileNumber) {
       case 1:
        {
          extern void sf_c1_FDIBenchMark_BLW_66_71_get_check_sum(mxArray
           *plhs[]);
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2668465391U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3668564524U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(892041134U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2227120184U);
  }
  return 1;
#else
  return 0;
  ...
  if(strcmp(commandName,"get_autoinheritance_info")) return 0;
  {
    ...
    switch(chartFileNumber) {
     case 1:
      {
        extern mxArray
        *sf_c1_FDIBenchMark_BLW_66_71_get_autoinheritance_info(void);
...
void FDIBenchMark_BLW_66_71_debug_initialize(void)
{
  _FDIBenchMark_BLW_66_71MachineNumber_ =
    sf_debug_initialize_machine("FDIBenchMark_BLW_66_71","sfun",0,2,0,0,0);
