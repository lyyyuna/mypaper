/* Include files */
#include "FDIBenchMark_sfun.h"
#include "c2_FDIBenchMark.h"
#define CHARTINSTANCE_CHARTNUMBER       (chartInstance.chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER    (chartInstance.instanceNumber)
#include "FDIBenchMark_sfun_debug_macros.h"
...
static SFc2_FDIBenchMarkInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c2_FDIBenchMark(void);
static void initialize_params_c2_FDIBenchMark(void);
static void enable_c2_FDIBenchMark(void);
static void disable_c2_FDIBenchMark(void);
static void finalize_c2_FDIBenchMark(void);
static void sf_c2_FDIBenchMark(void);
...
static void initialize_c2_FDIBenchMark(void)
{
  ...
  chartInstance.c2_is_active_c2_FDIBenchMark = 0U;
}
...
static void sf_c2_FDIBenchMark(void)
{
  ...
  *c2_b_ControlZone = c2_ControlZone;
  ...
  sf_debug_check_for_state_inconsistency(_FDIBenchMarkMachineNumber_,
...
const mxArray *sf_c2_FDIBenchMark_get_eml_resolved_functions_info(void)
{
...
/* SFunction Glue Code */
void sf_c2_FDIBenchMark_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_FDIBenchMark_get_autoinheritance_info(void)
{
 ...
 fullDebuggerInitialization)
{
  if(ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
    ...
    if(!sim_mode_is_rtw_gen(S)) {
      {
        ...
        chartAlreadyPresent =
          sf_debug_initialize_chart(_FDIBenchMarkMachineNumber_,
         2,
         1,
         1,
         7,
        ...
        if(chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_FDIBenchMarkMachineNumber_,chartInstance.chartNumber);
          sf_debug_set_chart_disable_implicit_casting(_FDIBenchMarkMachineNumber_,chartInstance.chartNumber,1);
          sf_debug_set_chart_event_thresholds(_FDIBenchMarkMachineNumber_,
           chartInstance.chartNumber,
           0,
           0,
           0);
    ...
    sf_debug_reset_current_state_configuration(_FDIBenchMarkMachineNumber_,chartInstance.chartNumber,chartInstance.instanceNumber);
  }
}

static void sf_opaque_initialize_c2_FDIBenchMark(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c2_FDIBenchMark();
  initialize_c2_FDIBenchMark();
}

static void sf_opaque_enable_c2_FDIBenchMark(void *chartInstanceVar)
{
  enable_c2_FDIBenchMark();
}

static void sf_opaque_disable_c2_FDIBenchMark(void *chartInstanceVar)
{
  disable_c2_FDIBenchMark();
}

static void sf_opaque_gateway_c2_FDIBenchMark(void *chartInstanceVar)
{
  sf_c2_FDIBenchMark();
}

static void sf_opaque_terminate_c2_FDIBenchMark(void *chartInstanceVar)
{
  if (sim_mode_is_rtw_gen(chartInstance.S) ||
   sim_mode_is_external(chartInstance.S)) {
    sf_clear_rtw_identifier(chartInstance.S);
  }
  finalize_c2_FDIBenchMark();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_FDIBenchMark(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_FDIBenchMark(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("FDIBenchMark",2);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("FDIBenchMark",2,"gatewayCannotBeInlinedMultipleTimes"));
    if(chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"FDIBenchMark",2,6);
      sf_mark_chart_reusable_outputs(S,"FDIBenchMark",2,1);
    }
    sf_set_rtw_dwork_info(S,"FDIBenchMark",2);
...
static void mdlRTW_c2_FDIBenchMark(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "FDIBenchMark", 2);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c2_FDIBenchMark(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway = sf_opaque_gateway_c2_FDIBenchMark;
  chartInstance.chartInfo.initializeChart = sf_opaque_initialize_c2_FDIBenchMark;
  chartInstance.chartInfo.terminateChart = sf_opaque_terminate_c2_FDIBenchMark;
  chartInstance.chartInfo.enableChart = sf_opaque_enable_c2_FDIBenchMark;
  chartInstance.chartInfo.disableChart = sf_opaque_disable_c2_FDIBenchMark;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c2_FDIBenchMark;
  chartInstance.chartInfo.mdlStart = mdlStart_c2_FDIBenchMark;
  chartInstance.chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_FDIBenchMark;
...
void c2_FDIBenchMark_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_FDIBenchMark(S);
    break;
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_FDIBenchMark(S);
    break;
   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_FDIBenchMark(S);
    break;
   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
     "Error calling c2_FDIBenchMark_method_dispatcher.\n"
