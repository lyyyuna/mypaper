...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
 const mxArray * prhs[] )
{
  extern unsigned int sf_FDIBenchMark_lyy_lpv_process_check_sum_call( int nlhs,
   mxArray * plhs[], int nrhs, const mxArray * prhs[] );

  if(sf_FDIBenchMark_lyy_lpv_process_check_sum_call(nlhs,plhs,nrhs,prhs)) return
  1;
  return 0;
}
...
{
  extern unsigned int sf_FDIBenchMark_lyy_lpv_autoinheritance_info( int nlhs,
   mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if(sf_FDIBenchMark_lyy_lpv_autoinheritance_info(nlhs,plhs,nrhs,prhs)) return
  1;
  return 0;
}
...
extern unsigned int sf_FDIBenchMark_lyy_lpv_method_dispatcher(SimStruct *S,
...
{
  if(sf_FDIBenchMark_lyy_lpv_method_dispatcher(simstructPtr,chartName,method,data))
  return 1;
  return 0;
}
extern void FDIBenchMark_lyy_lpv_terminator(void);
void sf_machine_global_terminator(void)
{
  if(sfMachineGlobalTerminatorCallable) {
    ...
    FDIBenchMark_lyy_lpv_terminator();
    sf_debug_terminate();
  }
  return;
}
extern void FDIBenchMark_lyy_lpv_initializer(void);
extern void FDIBenchMark_lyy_lpv_register_exported_symbols(SimStruct* S);
extern void FDIBenchMark_lyy_lpv_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  FDIBenchMark_lyy_lpv_register_exported_symbols(S);
}
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if(sfMachineGlobalInitializerCallable) {
    ...
    if(!simModeIsRTWGen) {
      FDIBenchMark_lyy_lpv_debug_initialize();
    }
    FDIBenchMark_lyy_lpv_initializer();
  }
  return;
}
