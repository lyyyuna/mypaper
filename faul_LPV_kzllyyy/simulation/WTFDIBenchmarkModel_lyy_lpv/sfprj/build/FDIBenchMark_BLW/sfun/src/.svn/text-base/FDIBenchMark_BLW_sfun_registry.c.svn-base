...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
 const mxArray * prhs[] )
{
  extern unsigned int sf_FDIBenchMark_BLW_process_check_sum_call( int nlhs,
   mxArray * plhs[], int nrhs, const mxArray * prhs[] );

  if(sf_FDIBenchMark_BLW_process_check_sum_call(nlhs,plhs,nrhs,prhs)) return 1;
  return 0;
}
unsigned int sf_process_autoinheritence_call( int nlhs, mxArray * plhs[], int
 nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_FDIBenchMark_BLW_autoinheritance_info( int nlhs,
   mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if(sf_FDIBenchMark_BLW_autoinheritance_info(nlhs,plhs,nrhs,prhs)) return 1;
  return 0;
}
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray
 * plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_FDIBenchMark_BLW_get_eml_resolved_functions_info( int
  ...
  if (!mxIsChar(prhs[0]) || !mxIsChar(prhs[1])) return 0;
  mxGetString(prhs[0], commandName,sizeof(commandName)/sizeof(char));
  commandName[(sizeof(commandName)/sizeof(char)-1)] = '\0';
  if(strcmp(commandName,"get_eml_resolved_functions_info")) return 0;
  mxGetString(prhs[1], machineName,sizeof(machineName)/sizeof(char));
  machineName[(sizeof(machineName)/sizeof(char)-1)] = '\0';
  if(strcmp(machineName, "FDIBenchMark_BLW") == 0) {
    const mxArray *newRhs[2] = { NULL, NULL };
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return
    sf_FDIBenchMark_BLW_get_eml_resolved_functions_info(nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_FDIBenchMark_BLW_method_dispatcher(SimStruct *S, unsigned
...
{
  if(!strcmp(machineName,"FDIBenchMark_BLW")) {
    return(sf_FDIBenchMark_BLW_method_dispatcher(simstructPtr,chartFileNumber,method,data));
  }
  return 0;
}
extern void FDIBenchMark_BLW_terminator(void);
void sf_machine_global_terminator(void)
{
  if(sfMachineGlobalTerminatorCallable) {
    ...
    FDIBenchMark_BLW_terminator();
    sf_debug_terminate();
  }
  return;
}
extern void FDIBenchMark_BLW_initializer(void);
extern void FDIBenchMark_BLW_register_exported_symbols(SimStruct* S);
extern void FDIBenchMark_BLW_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  FDIBenchMark_BLW_register_exported_symbols(S);
}
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if(sfMachineGlobalInitializerCallable) {
    ...
    if(!simModeIsRTWGen) {
      FDIBenchMark_BLW_debug_initialize();
    }
    FDIBenchMark_BLW_initializer();
  }
  return;
}
