...
#include "FDIBenchMark_BLW_sfun_debug_macros.h"
...
static SFc2_FDIBenchMark_BLWInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c2_FDIBenchMark_BLW(void);
static void initialize_params_c2_FDIBenchMark_BLW(void);
static void enable_c2_FDIBenchMark_BLW(void);
static void disable_c2_FDIBenchMark_BLW(void);
static void finalize_c2_FDIBenchMark_BLW(void);
static void sf_c2_FDIBenchMark_BLW(void);
...
static void initialize_c2_FDIBenchMark_BLW(void)
{
  ...
  chartInstance.c2_is_active_c2_FDIBenchMark_BLW = 0U;
}
...
static void sf_c2_FDIBenchMark_BLW(void)
{
  ...
  *c2_b_ControlZone = c2_ControlZone;
  ...
  sf_debug_check_for_state_inconsistency(_FDIBenchMark_BLWMachineNumber_,
...
const mxArray *sf_c2_FDIBenchMark_BLW_get_eml_resolved_functions_info(void)
{
...
/* SFunction Glue Code */
void sf_c2_FDIBenchMark_BLW_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(767111270U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3068925175U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1534567446U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4254490232U);
}

mxArray *sf_c2_FDIBenchMark_BLW_get_autoinheritance_info(void)
{
  ...
  mxCreateStructMatrix(1,1,4,autoinheritanceFields);
  {
    ...
    pr[0] = (double)(2621515216U);
    pr[1] = (double)(1115194197U);
    pr[2] = (double)(2146074619U);
    pr[3] = (double)(1725358718U);
 ...
 fullDebuggerInitialization)
{
  if(ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
    ...
    if(!sim_mode_is_rtw_gen(S)) {
      {
        ...
        chartAlreadyPresent =
          sf_debug_initialize_chart(_FDIBenchMark_BLWMachineNumber_,
         2,
         1,
         1,
         7,
        ...
        if(chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_FDIBenchMark_BLWMachineNumber_,chartInstance.chartNumber);
          sf_debug_set_chart_disable_implicit_casting(_FDIBenchMark_BLWMachineNumber_,chartInstance.chartNumber,1);
          sf_debug_set_chart_event_thresholds(_FDIBenchMark_BLWMachineNumber_,
           chartInstance.chartNumber,
           0,
           0,
           0);
        ...
        _SFD_CV_INIT_EML_IF(0,2,231,267,295,330);
        {
          ...
          _SFD_CV_INIT_EML_MCDC(0,0,125,158,2,0,&(condStart[0]),&(condEnd[0]),3,&(pfixExpr[0]));
        }
    ...
    sf_debug_reset_current_state_configuration(_FDIBenchMark_BLWMachineNumber_,chartInstance.chartNumber,chartInstance.instanceNumber);
  }
}

static void sf_opaque_initialize_c2_FDIBenchMark_BLW(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c2_FDIBenchMark_BLW();
  initialize_c2_FDIBenchMark_BLW();
}

static void sf_opaque_enable_c2_FDIBenchMark_BLW(void *chartInstanceVar)
{
  enable_c2_FDIBenchMark_BLW();
}

static void sf_opaque_disable_c2_FDIBenchMark_BLW(void *chartInstanceVar)
{
  disable_c2_FDIBenchMark_BLW();
}

static void sf_opaque_gateway_c2_FDIBenchMark_BLW(void *chartInstanceVar)
{
  sf_c2_FDIBenchMark_BLW();
}

static void sf_opaque_terminate_c2_FDIBenchMark_BLW(void *chartInstanceVar)
{
  if (sim_mode_is_rtw_gen(chartInstance.S) ||
   sim_mode_is_external(chartInstance.S)) {
    sf_clear_rtw_identifier(chartInstance.S);
  }
  finalize_c2_FDIBenchMark_BLW();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_FDIBenchMark_BLW(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_FDIBenchMark_BLW(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("FDIBenchMark_BLW",2);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("FDIBenchMark_BLW",2,"gatewayCannotBeInlinedMultipleTimes"));
    if(chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"FDIBenchMark_BLW",2,6);
      sf_mark_chart_reusable_outputs(S,"FDIBenchMark_BLW",2,1);
    }
    sf_set_rtw_dwork_info(S,"FDIBenchMark_BLW",2);
    ssSetHasSubFunctions(S,!(chartIsInlinable));
    ssSetOptions(S,ssGetOptions(S)|SS_OPTION_WORKS_WITH_CODE_REUSE);
  }

  ssSetChecksum0(S,(2451974695U));
  ssSetChecksum1(S,(3958491047U));
  ssSetChecksum2(S,(857014768U));
  ssSetChecksum3(S,(4099449164U));
...
static void mdlRTW_c2_FDIBenchMark_BLW(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "FDIBenchMark_BLW", 2);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c2_FDIBenchMark_BLW(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_FDIBenchMark_BLW;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c2_FDIBenchMark_BLW;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c2_FDIBenchMark_BLW;
  chartInstance.chartInfo.enableChart = sf_opaque_enable_c2_FDIBenchMark_BLW;
  chartInstance.chartInfo.disableChart = sf_opaque_disable_c2_FDIBenchMark_BLW;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c2_FDIBenchMark_BLW;
  chartInstance.chartInfo.mdlStart = mdlStart_c2_FDIBenchMark_BLW;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_FDIBenchMark_BLW;
...
void c2_FDIBenchMark_BLW_method_dispatcher(SimStruct *S, int_T method, void
 *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_FDIBenchMark_BLW(S);
    break;
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_FDIBenchMark_BLW(S);
    break;
   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_FDIBenchMark_BLW(S);
    break;
   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
     "Error calling c2_FDIBenchMark_BLW_method_dispatcher.\n"
