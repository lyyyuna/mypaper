...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
 const mxArray * prhs[] )
{
  extern unsigned int sf_FDIBenchMark_BLW_66_71_process_check_sum_call( int
 ...
 nrhs, const mxArray * prhs[] )
{
  ...
  if(sf_FDIBenchMark_BLW_66_71_autoinheritance_info(nlhs,plhs,nrhs,prhs)) return
  1;
  return 0;
}
...
{
  if(sf_FDIBenchMark_BLW_66_71_method_dispatcher(simstructPtr,chartName,method,data))
  return 1;
  return 0;
}
