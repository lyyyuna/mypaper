...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_FDIBenchMark_BLW_66_71_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_FDIBenchMark_BLW_66_71_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_FDIBenchMark_BLW_66_71_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_FDIBenchMark_BLW_66_71_autoinheritance_info(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_FDIBenchMark_BLW_66_71_get_eml_resolved_functions_info(
  ...
  if (strcmp(machineName, "FDIBenchMark_BLW_66_71") == 0) {
    const mxArray *newRhs[2] = { NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_FDIBenchMark_BLW_66_71_get_eml_resolved_functions_info(nlhs,plhs,2,
      newRhs);
  }
...
extern unsigned int sf_FDIBenchMark_BLW_66_71_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"FDIBenchMark_BLW_66_71")) {
    return(sf_FDIBenchMark_BLW_66_71_method_dispatcher(simstructPtr,
...
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    FDIBenchMark_BLW_66_71_terminator();
    sf_debug_terminate();
  }
...
extern void FDIBenchMark_BLW_66_71_register_exported_symbols(SimStruct* S);
extern void FDIBenchMark_BLW_66_71_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  FDIBenchMark_BLW_66_71_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      FDIBenchMark_BLW_66_71_debug_initialize();
    }

    FDIBenchMark_BLW_66_71_initializer();
  }
