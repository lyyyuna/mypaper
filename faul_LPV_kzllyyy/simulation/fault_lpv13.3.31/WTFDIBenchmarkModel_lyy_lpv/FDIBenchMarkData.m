...
D_v_wind=[Time', 20+0*sin(0.01*Time)'];
% load winddata
...
D_Fault1=[Time' 1-[zeros(1,300/Ts)]'];
D_Fault2=[Time' 1-[zeros(1,300/Ts)]'];
D_Fault3=[Time' 1-[zeros(1,300/Ts)]'];
D_Fault4=[Time' 1-[zeros(1,300/Ts)]'];
D_Fault5=[Time' 1-[zeros(1,300/Ts)]'];
D_Fault6=[Time' 1-[zeros(1,300/Ts)]'];
D_Fault7=[Time' 1-[zeros(1,300/Ts)]'];
D_Fault8=[Time' 1-[zeros(1,300/Ts)]'];
D_Fault9=[Time' 1-[zeros(1,300/Ts)]'];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Noise Seeds
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
