...
\author{Dinghui Wu \and Yiyang Li \and Zhicheng Ji} % if too long for running head
\authorrunning{D.H. Wu, Y.Y. Li, Z.C. Ji} % if too long for running head
\institute{D.H. Wu (Corresponding author) \and Y.Y. Li \and Z.C. Ji \at
              Key Laboratory of Advanced Process Control for Light
              Industry (Ministry of Education), Jiangnan University, Wuxi\ 214122, Peoples' Republic of China\\
 \and
           D.H. Wu \at
           Control Science and Engineering Research Center, Jiangnan University, Wuxi\ 214122, Peoples' Republic of China
...
better than the common Kalman filter.
 ...
 \keywords{Wind turbine \and Kalman filter
\and fault diagnosis \and multi-innovation}
\end{abstract}
...
\bibitem{DF2014_ND_WangC} Wang, C., Tang, T.: Several gradient-based iterative estimation algorithms for a class of nonlinear systems using the filtering technique. Nonlinear Dyn. {\bf 77}(3), 769-780 (2014)
\bibitem{DF2015_ND_JiY}Ji, Y., Liu, X.M., et al.:  Ji Y, Liu XM, Ding F. New criteria for the robust impulsive synchronization of uncertain chaotic delayed nonlinear systems. Nonlinear Dyn. 2015. doi: 10.1007/s11071-014-1640-6
